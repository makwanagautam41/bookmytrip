...
$busCountQuery = "SELECT COUNT(*) AS bus_count FROM buses";

$userResult = mysqli_query($conn, $userCountQuery);
$bookingResult = mysqli_query($conn, $bookingCountQuery);
$busResult = mysqli_query($conn, $busCountQuery);

$userCount = mysqli_fetch_assoc($userResult)['user_count'];
$bookingCount = mysqli_fetch_assoc($bookingResult)['booking_count'];
$busCount = mysqli_fetch_assoc($busResult)['bus_count'];
?>
...
<body>
  ...
  <div class="container">
    <div class="dashboard-box">
      <a href="manage_users.php" class="box">
        <h3><?php echo $userCount; ?></h3>
        <p>Users</p>
      </a>
      <a href="view_bookings.php" class="box">
        <h3><?php echo $bookingCount; ?></h3>
        <p>Bookings</p>
      </a>
      <a href="view_bus.php" class="box">
