...
<body>
  ...
  <main>
    ...
    <a href="admin_register.php" class="addAdmin text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2">
      <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 448 512" width="24px" fill="#e8eaed">
        <path d="M96 128a128 128 0 1 0 256 0A128 128 0 1 0 96 128zm94.5 200.2l18.6 31L175.8 483.1l-36-146.9c-2-8.1-9.8-13.4-17.9-11.3C51.9 342.4 0 405.8 0 481.3c0 17 13.8 30.7 30.7 30.7l131.7 0c0 0 0 0 .1 0l5.5 0 112 0 5.5 0c0 0 0 0 .1 0l131.7 0c17 0 30.7-13.8 30.7-30.7c0-75.5-51.9-138.9-121.9-156.4c-8.1-2-15.9 3.3-17.9 11.3l-36 146.9L238.9 359.2l18.6-31c6.4-10.7-1.3-24.2-13.7-24.2L224 304l-19.7 0c-12.4 0-20.1 13.6-13.7 24.2z" />
      </svg>
      Add Admin
    ...
    <div class="flex flex-wrap justify-center gap-6">
      <?php while ($admin = $admins->fetch_assoc()): ?>
        <div class="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800 m-50" style="width: 100%; height:100%;">
          <img src="<?php echo $admin['profile_image']; ?>" alt="<?php echo htmlspecialchars($admin['name']) ?>" class="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square">
          <div class="space-y-4 text-center divide-y dark:divide-gray-300">
            <div class="my-2 space-y-1">
              <h2 class="text-xl font-semibold sm:text-2xl"><?php echo htmlspecialchars($admin['name']) ?></h2>
              <p class="px-5 text-xs sm:text-base dark:text-gray-600" style="margin-left: -1rem;"><?php echo htmlspecialchars($admin['email']) ?></p>
            </div>
