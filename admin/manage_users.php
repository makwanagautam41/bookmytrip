            ...
            <tbody>
                ...
                <?php while ($user = $result->fetch_assoc()): ?>
                    <tr>
                      ...
                      <td><?php echo htmlspecialchars($user['adhar']); ?></td>
                      <td style="color:green;"><?php echo htmlspecialchars($user['status']); ?></td>
                      <td>
                          <a href="deleteUser.php?user_id=<?php echo urldecode($user['id']);?>">
