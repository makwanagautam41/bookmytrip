...
// Generate reports here (example: total revenue)
$query = "SELECT SUM(total_fare) as total_revenue FROM bookings";
...
<body>
  ...
  <main>
    <div class="container">
        <h1>Reports</h1>
        <h2>Total Revenue</h2>
        <p>Total revenue from bookings: $<?php echo htmlspecialchars(number_format($total_revenue, 2)); ?></p>
