...
// Automatically delete expired bookings
$currentDate = date('Y-m-d');
$deleteQuery = "DELETE FROM bookings WHERE date_of_journey < '$currentDate'";
...
<body>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <div>
            ...
            <li class="active"><a href="view_bookings.php">View Bookings</a></li>
          </div>
        </ul>
      </li>
      <li >
  ...
  <main>
    <div class="container">
              ...
              <?php if ($result->num_rows > 0): ?>
                <?php while ($booking = $result->fetch_assoc()): ?>
                  <tr>
                      ...
                      <td><?php echo htmlspecialchars($booking['date_of_journey']); ?></td>
                      ...
                      <!-- <td>
                          <a href="../cancel_booking.php?id=<?php echo $booking['id']; ?>">
                              <button class="button" type="button">Cancel Booking</button>
                          </a>
                      </td> -->
                  </tr>
                <?php endwhile; ?>
        ...
        <?php else: ?>
            <p style="color: #000;">No Booking found.</p>
          <?php endif; ?>
    </div>
  </main>
